...
//float speedRaw=180-anglS; //180 used as its the value we balance of
//float speedRawX=60-anglS;
//float speedRawY=270-anglS;
//float speedRaw=speedRawY-speedRawX;
...
//when you just get the biggest think
//anglDT=360-anglD; //true angle in degrees, basicly angle value repalces numbers lower than 180 to their higher than 180 counterparts
float anglST=anglSHigh-anglS;
...
if(180>anglD){
speedRaw=-speedRaw; //neg
};

//if(anglD>0 && 90>anglD){
//speedRaw=-speedRaw; //neg
//};
//if(anglD>90 && 180>anglD){
//speedRaw=speedRaw; //pos
//};
//if(anglD>180 && 270>anglD){
//speedRaw=speedRaw; //pos
//};
//if(anglD>270 && 360>anglD){
//speedRaw=-speedRaw; //neg
//};


//float speedRaw = speedRaw=180-anglS;;
//if(anglD>0 && 90>anglD){
//speedRaw=-speedRaw; //neg
//};
//if(anglD>90 && 180>anglD){
