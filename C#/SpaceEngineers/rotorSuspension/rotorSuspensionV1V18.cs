...
if(anglTrgt > 270){
anglTrgt=anglTrgt-((anglTrgt-270)*2);
}else{
if(anglTrgt > 180 ){
anglTrgt=anglTrgt-((anglTrgt-270)*2);
};
...
if(90 > anglTrgt){
anglTrgt=anglTrgt+((90-anglTrgt)*2);
}else{
if(180 > anglTrgt){
anglTrgt=anglTrgt+((90-anglTrgt)*2);
};
...
////float anglM = anglD/180*anglTrgt; //curr angle of rotor in degrees, using the target angle as the middle point instead of 180
...
//float anglS=anglTrgt-180+anglD;
//float anglS=(180-anglTrgt+anglD)-anglTrgt;
//float anglS=(360-anglTrgt+anglD)-180;
//float anglS=(anglD-anglTrgt)+anglTrgt;
float anglS=-(anglD+anglTrgt-360);
if(0>anglS){anglS=anglS+360;};
float anglT = anglD; //true angle basicly anything below 180 is set to their higher than 180 counterpart
if(180>anglT){
//anglT=anglT+180;
anglT=360-anglT;
};
...
////log(consoles,"currAMiddled: "+anglM);
log(consoles,"currAShifted: "+anglS);
log(consoles,"currAShiftedHigh: "+anglSHigh);
log(consoles,"currATrue: "+anglT);

//float speedRaw=anglS;
