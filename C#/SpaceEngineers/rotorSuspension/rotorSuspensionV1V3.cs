...
float rpm = 30; //set to maximum rotor rpm
...
float anglTrgtS = anglTrgt/180*anglTrgt; //shifted target angle.
//float angMid = Convert.ToSingle(180*Math.PI/180); //180Deg in radians
int angDir=0;

//log(consoles,"anglTrgtS: "+anglTrgtS);

log(consoles,"currA: "+anglD);
//log(consoles,"currATrgtNorm: "+angl);
...
log(consoles,"angDir: "+angDir);

//float speed=angl-anglTrgt/anglTrgt*rpm; //RPM
//float speed=angl/anglTrgt*rpm;
//float speed=anglD/anglTrgt*rpm;
//float speed=angl*anglTrgt/anglTrgt*rpm;
//float speed=anglD/anglTrgt*rpm;
//float speed=anglD-anglTrgt/anglTrgt*rpm; //RPM
//float speed=5;
//float speed=180-anglS;
//float speed=180-anglS;
//float speed=180-anglS;
//float speed=180-anglS;
//float speed=180-anglS;
//float speed=180-anglS;
//float speed=anglS-180/anglSHigh*rpm;
