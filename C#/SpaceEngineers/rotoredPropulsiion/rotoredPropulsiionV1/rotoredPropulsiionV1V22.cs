...
int steering=40; //max steering angle //no work to left
//options end
//****//****//****//****//****//****//****//****//****//****//****//****//****//****//****//
//variables
int runCount = 0;
...
if(controllType==1){
if(custMov>0){
if(angMid>steer){wheel.TargetVelocityRPM=SRPM*(mov.X*(custMov*custRol)*custRot);}else{
wheel.TargetVelocityRPM=0;
};
};
if(0>custMov){
if(steer>angMid){wheel.TargetVelocityRPM=SRPM*(mov.X*(-custMov*custRol)*custRot);}else{
wheel.TargetVelocityRPM=0;
};
};
};
