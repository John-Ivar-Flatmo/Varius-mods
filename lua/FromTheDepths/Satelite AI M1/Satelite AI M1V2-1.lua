...
acrsy = 10 -- how close to the target it will try to be stay where 0 is on the target
...
blnsTrn = 0 --from 0-359 the yaw to balance on, basicly the orientation of the vehicle.
