...
acrsyPtsj = 1 -- how close to the direction to the target it will try to stay at. where 0 is directly towards the target
...
blnsPtsj = 180 --from 0-359 the yaw to balance on, basicly the orientation of the vehicle.
...
cntrlPitchAim = true --wheter or not to aim at a target, if this is on balancing will be turned of whilst aiming at target but turned back on after combat
...
--I:LogToHud("blnsPtsj: "..blnsPtsj)

blnsAng1 = blnsPtsj+acrsyTrn
--if blnsAng1 > 360 then blnsAng1 = blnsAng1-360 end
--if 0 > blnsAng1 then blnsAng1 = 360+blnsAng1 end
if blnsAng1 > 360 then blnsAng1 = blnsPtsj end
if 0 > blnsAng1 then blnsAng1 = blnsPtsj end
--I:LogToHud("blnsAng1: "..blnsAng1)

blnsAng2 = blnsPtsj-acrsyTrn
--if blnsAng2 > 360 then blnsAng2 = blnsAng2-360 end
--if 0 > blnsAng2 then blnsAng2 = 360+blnsAng2 end
if blnsAng2 > 360 then blnsAng2 = blnsPtsj end
if 0 > blnsAng2 then blnsAng2 = blnsPtsj end
--I:LogToHud("blnsAng2: "..blnsAng2)

trn(I,yaw,blnsPtsj,vctrUp)
...
--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//
-- up/down start
if cntrlPitchEnabled == true then
pitch = I:GetConstructPitch()
I:LogToHud("pitch: "..pitch)
--I:Log("pitch: "..pitch)
vctrFrwrd = I:GetConstructForwardVector()
--I:LogToHud("vctrFrwrd.x: "..vctrFrwrd.x)
--I:LogToHud("vctrFrwd.y: "..vctrFrwrd.y)
...
--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//
--balance start
if cntrlPitchBlns == true then
if trgtPos ~= false and cntrlPitchAim == true then
...
pitchNrml = pitch
pitchNrml = pitchNrml+90
pitchNrml = pitchNrml*2
I:LogToHud("pitchNrml :"..pitchNrml)

ptsj(I,pitchNrml,blnsPtsj,vctrUp)
...
--trgtPtsj = Mathf.Atan2(pos.x*pos.z,trgtPos.Position.y) * Mathf.Rad2Deg
--trgtPtsj = Mathf.Atan2(pos.y,trgtPos.Position.y) * Mathf.Rad2Deg
trgtPtsj = Mathf.Atan(Mathf.Lerp(pos.y,trgtPos.Position.y,0.5))
--trgtPtsj = 90*Mathf.Atan((pos.y*trgtPos.Position.y)/2)
I:LogToHud("trgtPtsj: "..trgtPtsj) !!find y angle to aim at !!

trgtPtsjNrml = trgtPtsj
trgtPtsjNrml = trgtPtsjNrml*90
trgtPtsjNrml = trgtPtsjNrml+90
--trgtPtsjNrml = trgtPtsjNrml*2
--trgtPtsjNrml = trgtPtsjNrml+180
I:LogToHud("trgtPtsjNrml: "..trgtPtsjNrml)

blnsAng1 = trgtPtsjNrml+acrsyTrn
--if blnsAng1 > 360 then blnsAng1 = blnsAng1-360 end
--if 0 > blnsAng1 then blnsAng1 = 360+blnsAng1 end
if blnsAng1 > 360 then blnsAng1 = trgtPtsjNrml end
if 0 > blnsAng1 then blnsAng1 = trgtPtsjNrml end
--I:LogToHud("blnsAng1: "..blnsAng1)

blnsAng2 = trgtPtsjNrml-acrsyTrn
--if blnsAng2 > 360 then blnsAng2 = blnsAng2-360 end
--if 0 > blnsAng2 then blnsAng2 = 360+blnsAng2 end
if blnsAng2 > 360 then blnsAng2 = trgtPtsjNrml end
if 0 > blnsAng2 then blnsAng2 = trgtPtsjNrml end
--I:LogToHud("blnsAng2: "..blnsAng2)

ptsj(I,pitchNrml,trgtPtsjNrml,vctrUp)
...
blnsAng1 = trgt+acrsyTrn
--if blnsAng1 > 360 then blnsAng1 = blnsAng1-360 end
--if 0 > blnsAng1 then blnsAng1 = 360+blnsAng1 end
if blnsAng1 > 360 then blnsAng1 = trgt end
if 0 > blnsAng1 then blnsAng1 = trgt end
I:LogToHud("blnsAng1: "..blnsAng1)

blnsAng2 = trgt-acrsyTrn
--if blnsAng2 > 360 then blnsAng2 = blnsAng2-360 end
--if 0 > blnsAng2 then blnsAng2 = 360+blnsAng2 end
if blnsAng2 > 360 then blnsAng2 = trgt end
if 0 > blnsAng2 then blnsAng2 = trgt end
I:LogToHud("blnsAng2: "..blnsAng2)

if yaw >= 0 and 180 >= yaw then

if blnsAng1 >= 0 and 180 >= blnsAng2 then
if blnsAng1 > yaw then
trnChk(I,true,vctrUp)
end --trgt > yaw
if yaw > blnsAng2 then
trnChk(I,false,vctrUp)
end --yaw > trgt
end --trgt > 0 and 180 >= trgt //trgt wthn 0-181 end

if blnsAng1 > 180 and 270 >= blnsAng2 then
trnChk(I,true,vctrUp)
end --trgt > 180 and 270 > trgt //trgt wthn 180-270 end

if blnsAng1 > 270 and 360 > blnsAng2 then
trnChk(I,false,vctrUp)
...
if blnsAng1 >= 180 and 360 > blnsAng2 then
if blnsAng1 > yaw then
trnChk(I,true,vctrUp)
end --trgt > yaw
if yaw > blnsAng2 then
...
if blnsAng1 >= 0 and 90 >= blnsAng2 then
trnChk(I,true,vctrUp)
end --trgt > 0 and 90 >= trgt //trgt wthn 0-91 end

if blnsAng1 >= 90 and 180 >= blnsAng2 then
trnChk(I,false,vctrUp)
...
--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//
--ptsj start
function ptsj(I,pitch,trgt,vctrUp) --pitch = pitch 0-360 | trgt = 0-360 angle

blnsAng1 = trgt+acrsyPtsj
--if blnsAng1 > 360 then blnsAng1 = blnsAng1-360 end
--if 0 > blnsAng1 then blnsAng1 = 360+blnsAng1 end
if blnsAng1 > 360 then blnsAng1 = trgt end
if 0 > blnsAng1 then blnsAng1 = trgt end
...
if pitch >= 0 and 180 >= pitch then

if blnsAng1 >= 0 and 180 >= blnsAng2 then
if blnsAng1 > pitch then
ptsjChk(I,true,vctrUp)
end --trgt > pitch
if pitch > blnsAng2 then
ptsjChk(I,false,vctrUp)
end --pitch > trgt
end --trgt > 0 and 180 >= trgt //trgt wthn 0-181 end
...
end --pitch > 0 and 180 >= pitch end

if pitch > 180 and 360 > pitch then
...
end --pitch > 180 and 360 > pitch end

end --ptsj end
--ptsj end
--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//--//
function ptsjChk(I,ptsjUp,vctrUp)
if ptsjUp == true then
if vctrUp.y > 0 then
I:RequestComplexControllerStimulus(cntrlPitchUp)
else --upsideup
I:RequestComplexControllerStimulus(cntrlPitchDown)
end --upsidedown
end --ptsjup true
if ptsjUp == false then
if vctrUp.y > 0 then
I:RequestComplexControllerStimulus(cntrlPitchDown)
else --upsideup
I:RequestComplexControllerStimulus(cntrlPitchUp)
